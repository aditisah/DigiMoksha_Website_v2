...
.text-\[\#9FCC3B\]{
  --tw-text-opacity: 1;
  color: rgb(159 204 59 / var(--tw-text-opacity));
}
...
@font-face {
  ...
  src: url('../fonts/Sombra-Variable-Demo/Sombra-Variable-Demo.ttf') format('truetype'),
     url('../fonts/Sombra-Variable-Demo/Sombra-Variable-Demo.woff') format('woff'),
     url('../fonts/Sombra-Variable-Demo/Sombra-Variable-Demo.woff2') format('woff2');
